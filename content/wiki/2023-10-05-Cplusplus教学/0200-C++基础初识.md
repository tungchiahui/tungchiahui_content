...
如果你还没有完成上一章的工程环境搭建，请先看从 [C++开发环境与第一个工程](/wiki/2023-10-05-cplusplus-jiao-xue/0100-c-kai-fa-huan-jing-da-jian-yu-ce-shi) 开始，本教程一直使用同一个 CMake 模板。写到这里时，你的工程大致还是这个结构.
