...
- [17-1-1 std::vector](ch17-1-1-std-vector) — 动态数组（最常用的容器，首选）
...
- [17-1-5 std::set / std::unordered_set](ch17-1-5-std-set-unordered-set) — 集合容器（自动去重）
- [17-1-6 queue / stack / deque](ch17-1-6-queue-stack-deque) — 队列、栈、双端队列
- [17-1-7 iterator](ch17-1-7-iterator) — 迭代器（统一遍历方式）
- [17-1-8 algorithm](ch17-1-8-algorithm) — 算法库（排序、查找、变换等）
...
开始学习第一个容器 → [17-1-1 std::vector](ch17-1-1-std-vector)
